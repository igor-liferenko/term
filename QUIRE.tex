...
%
% We need to keep margin size fixed. Therefore, we make \hsize depend on number of
% pages (see README). But when we do this, a bug in quire.tex exhibits itself.
% Output of test_quire.tex demonstrates the bug.
% On the contrary, output of test_QUIRE.tex is correct.
